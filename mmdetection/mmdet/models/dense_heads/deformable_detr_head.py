...
class DeformableDETRHead(DETRHead):
    ...
    def predict(self,
        ...
        predictions, cls_scores  = self.predict_by_feat(# -----------lyq:add ', cls_scores'-----------
            *outs, batch_img_metas=batch_img_metas, rescale=rescale)
        return predictions, cls_scores # -----------lyq:add ', cls_scores'-----------
    ...
    def predict_by_feat(self,
        ...
        return result_list, cls_scores # -----------lyq:add ', cls_scores'-----------
