...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def predict(self,
        ...
        predictions, scores = self.predict_by_feat( # -----------------lyq:add ',scores'----------------
            *outs, batch_img_metas=batch_img_metas, rescale=rescale)
        return predictions, scores  # -----------------lyq:add ',scores'----------------
    ...
    def predict_by_feat(self,
        ...
        for img_id in range(len(batch_img_metas)):
            ...
            results = self._predict_by_feat_single(#lyq
        ...
        return result_list, cls_scores #lyq
    ...
    def _predict_by_feat_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, score_factor, priors) in \
            ...
            # in v3det.
            if False:#getattr(self.loss_cls, 'custom_cls_channels', False):
